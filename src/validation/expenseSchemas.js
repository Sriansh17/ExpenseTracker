...
module.exports = {
  ...
  create: Joi.object({ amount: Joi.number().integer().min(1).max(999999999).required(), categoryId: uuid.required(), date: notFuture.required(), notes: Joi.string().max(500).allow('').optional(), tags: tags.optional() }),
